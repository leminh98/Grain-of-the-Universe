...
//	BackStory_box.alignment = diy.settings.getTextAlignment('AHLCG-Story-Story-alignment');
	BackStory_box.defaultStyle = diy.settings.getTextStyle('AHLCG-Story-style', null);
	BackStory_box.alignment = diy.settings.getTextAlignment('AHLCG-Story-alignment');
