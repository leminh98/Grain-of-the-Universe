...
*/
	...
	this.bodyFontSize = 8.0;
	this.bodyFontWidth = 1.0;
	this.bodyFontWeight = WEIGHT_REGULAR;
	this.bodyFontTracking = 0.00;
	this.bodyStorySize = 8.0;
	this.bodyTraitSize = 7.2;
	this.bodyFlavorSize = 7.2;
	this.bodyStoryWidth = 0.9;
	this.bodyTraitWidth = 0.9;
	this.bodyFlavorWidth = 0.9;
	this.bodyStoryTracking = -0.01;
	this.bodyTraitTracking = 0.00;
	this.bodyFlavorTracking = -0.01;
	this.smallLabelSize = 4.4;
	this.smallLabelWeight = WEIGHT_REGULAR;
	this.smallLabelWidth = 0.92;
	this.smallLabelTracking = 0.00;
	this.largeLabelSize = 5.6;
	...
	this.collectionSize = 4.2;
	this.collectionWeight = WEIGHT_BOLD;
	this.collectionWidth = 1.0;
	this.collectionTracking = 0.01;
	this.difficultySize = 5.6;
	this.difficultyWeight = WEIGHT_BOLD;
	this.difficultyWidth = 0.97;
	this.difficultyTracking = 0.0;

	this.symbolSize = 7;
//	if ( this.OS == "Mac" ) this.symbolSize = 6.5;
	
	if (fontFamily == 'Arno Pro') {
		this.bodyFamily = 'Arno Pro';
//		this.bodyFamily = registerTTFont( 'ArnoPro-Bold', 'ArnoPro-BoldItalic', 'ArnoPro-Italic', 'ArnoPro-Regular' );
//		fontfiles = 'ArkhamHorrorLCG/fonts/ArnoPro-Bold.ttf, ArkhamHorrorLCG/fonts/ArnoPro-BoldItalic.ttf, ArkhamHorrorLCG/fonts/ArnoPro-Italic.ttf, ArkhamHorrorLCG/fonts/ArnoPro-Regular.ttf';
//		regresults = ResourceKit.registerFontFamily(fontfiles);
//		this.bodyFamily = regresults[0].getFamily();
			...
			this.smallLabelWeight = WEIGHT_BOLD;
//			this.smallLabelWidth = 0.92;
			this.smallLabelWidth = 1.0;
			this.smallLabelTracking = 0.00;
...
/*
			...
			this.bodyFontSize = this.bodyFontSize * 1.18;
			this.bodyTraitSize = this.bodyTraitSize * 1.22;
			this.bodyFlavorSize = this.bodyFlavorSize * 1.22;
			this.bodyStorySize = this.bodyStorySize * 1.22;
