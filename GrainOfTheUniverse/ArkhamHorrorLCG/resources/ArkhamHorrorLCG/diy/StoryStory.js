...
function createInterface( diy, editor ) {
	...
	var BackStatPanel = layoutStoryBackStats( bindings, FACE_BACK );
...
function paintFront( g, diy, sheet ) {
	...
	drawCollectorInfo( g, diy, sheet, collectionBox, collectionSuffix, $ShowCollectionNumberFront == '1', encounterBox, true, Copyright_box, null );
}
...
function paintBack( g, diy, sheet ) {
	...
	BackCopyright_box.defaultStyle = diy.settings.getTextStyle(getExpandedKey( FACE_BACK, 'Copyright-style'), null);
	BackEncounter_box.setDefaultStyle( diy.settings.getTextStyle(getExpandedKey( FACE_BACK, 'EncounterNumber-style'), null) );
	...
	if ( $TemplateBack == 'Story' ) {
		...
		drawCollectorInfo( g, diy, sheet, collectionBox, collectionSuffix, $ShowCollectionNumberBack == '1', encounterBox, true, BackCopyright_box, null );
	}
